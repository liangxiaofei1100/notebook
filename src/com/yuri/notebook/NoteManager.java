...
public class NoteManager {
	...
	public static Note getNotesFromId(long id, Context context){
		...
		try {
			...
			if (cur.moveToFirst()) {
				do {
					noteBook.setObjectId(cur.getString(cur.getColumnIndex(NoteColumns.OBJECT_ID)));
					noteBook.setContent(cur.getString(cur.getColumnIndex(NoteColumns.CONTENT)));
					noteBook.setGroup(cur.getString(cur.getColumnIndex(NoteColumns.GROUP)));
					noteBook.setTime(cur.getLong(cur.getColumnIndex(NoteColumns.TIME)));
